...
namespace View
{
    public class MainWindowViewModel
    {
        ...
        public void ImportCSV(string masterDataFilepath, string routeNumberFilepath, string FNfile)
        {
            iOController.InitializeImport(masterDataFilepath, routeNumberFilepath, FNfile);
        }
